...
class World(object):
    ...
    def draw(self, robot, filtered):
        ...
        self.pygame.draw.circle(self.window, COLOR["purple"], (filtered[0], WINDOWHEIGHT - filtered[1]), 5)
    ...
    def render(self, robot, filtered):
        self.draw(robot, filtered)
